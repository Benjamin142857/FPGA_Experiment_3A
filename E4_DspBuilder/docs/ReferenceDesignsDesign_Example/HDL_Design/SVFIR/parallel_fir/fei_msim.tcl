...
set proj_topdir       "C:/p4_workspace/Design_Example/HDL_Design/SVFIR/parallel_fir"
...
vcom -work work -93 -explicit $srcdir/parallel_type_pkg.vhd
vcom -work work -93 -explicit $srcdir/shift_taps.vhd
vcom -work work -93 -explicit $srcdir/parallel_fir.vhd
                                                                                                                                                                                  
# compiling the testbench
vcom -work work $srcdir/tb_parallel_fir.vhd

# simulate the design
vsim -t ps work.tb_parallel_fir

add wave *
add wave tb_parallel_fir/parallel_fir_inst/*
add wave tb_parallel_fir/parallel_fir_inst/delay_tap/*
