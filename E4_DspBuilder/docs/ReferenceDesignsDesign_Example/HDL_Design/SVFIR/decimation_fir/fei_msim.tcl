...
set proj_topdir       "C:/p4_workspace/Design_Example/HDL_Design/SVFIR/decimation_fir"
...
vcom -work work -93 -explicit $srcdir/decimation_type_pkg.vhd
vcom -work work -93 -explicit $srcdir/shift_taps.vhd
vcom -work work -93 -explicit $srcdir/delay_tap_chain.vhd
vcom -work work -93 -explicit $srcdir/accum_sload.vhd
vcom -work work -93 -explicit $srcdir/coeff_rom.vhd
vcom -work work -93 -explicit $srcdir/decimation_fir.vhd
                                                                                                                                                                                  
# compiling the testbench
vcom -work work $srcdir/tb_decimation_fir.vhd

# simulate the design
vsim -t ps work.tb_decimation_fir

add wave *
add wave tb_decimation_fir/decimation_fir_inst/*
add wave tb_decimation_fir/decimation_fir_inst/tap_inst/*
add wave tb_decimation_fir/decimation_fir_inst/accum_sload_inst/*
