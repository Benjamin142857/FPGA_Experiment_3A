...
adderOutShift = 3*ones(1,numRates); % number of left shifts of the final adder output; the same length as the rate factor R
accumOutWidth = dataWidth + ceil(log2(Rmax))+0; % final accumulator bit growth is log2(Rmax)
accumOutShift = [3 3 2 2 2]; %number of left shifts of the final accumulator output; the same length as the rate factor R
