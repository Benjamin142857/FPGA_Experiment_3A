...
if (code_param.coded)
    ...
    elseif ( ( sim_param.code_configuration == 1)|(sim_param.code_configuration == 4)|(sim_param.code_configuration == 5) ) % turbo
        [N1,K1] = size( sim_param.g1 );
    ...
    for bicm_iter=1:bicm_iterations   
        ...
        elseif (( sim_param.code_configuration == 1) | ( sim_param.code_configuration == 4) | ( sim_param.code_configuration == 5)) % PCCC or UMTS
