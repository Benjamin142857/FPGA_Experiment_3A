...
#ifndef INC_PSW_SISODECODER_FXP_H
#define INC_PSW_SISODECODER_FXP_H
...
{
public:
	pSW_sisoDecoder_fxp(vector<data_fix_type> *output_u,
...
private:
	pSW_sisoDecoder_fxp() {} // disbale the constructor
...
#endif /* INC_PSW_SISODECODER_FXP_H */
