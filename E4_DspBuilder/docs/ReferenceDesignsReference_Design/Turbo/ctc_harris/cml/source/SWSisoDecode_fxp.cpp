				 ...
				 const mxArray *prhs[] )
{
	...
	pSW_sisoDecoder_fxp siso ( &output_u_fxp, &output_c_fxp, &output_b_fxp, &output_llr_fxp, out0, state0, out1, state1,
		input_u_fxp, input_c_fxp, KK, nn, DataLength, dec_type, num_subblocks, subblock_size, 
