...
for mcount=1:length(M)
    for hcount=1:length(h)
        ...
        filename = strcat( filename, '_AWGN_Coherent.mat' );
        ...
        sim_param(record).csi_flag = 0; % coherent detection
