...
sim_param(record).input_filename = 'BwCapacityFading';
sim_param(record).scenarios = numB*(record-1)+1:numB*record;
sim_param(record).linetype = 'k-';
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK2SNRvsB.mat' );
...
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK4SNRvsB.mat' );
...
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK8SNRvsB.mat' );
...
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK16SNRvsB.mat' );
...
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK32SNRvsB.mat' );
...
sim_param(record).legend = sim_param(record).comment;
sim_param(record).filename = strcat( data_directory, 'FSK64SNRvsB.mat' );
