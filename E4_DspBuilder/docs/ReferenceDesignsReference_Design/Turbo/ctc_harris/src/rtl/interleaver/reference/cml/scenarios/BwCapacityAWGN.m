...
for i=1:length(B)
    ...
    sim_param(record).input_filename = 'load hFskAWGNCap';
    ...
    sim_param(record).filename = strcat( data_directory, ['FSK2B' int2str(10*B(i)) '_AWGN.mat'] );
end
...
for i=1:length(B)
    ...
    sim_param(record).bwconstraint = B(i);
    sim_param(record).bwdatabase = 'BW99percent';
    sim_param(record).filename = strcat( data_directory, ['FSK4B' int2str(10*B(i)) '_AWGN.mat'] );
end
...
for i=1:length(B)
    ...
    sim_param(record).bwconstraint = B(i);
    sim_param(record).bwdatabase = 'BW99percent';
    sim_param(record).filename = strcat( data_directory, ['FSK8B' int2str(10*B(i)) '_AWGN.mat'] );
end
...
for i=1:length(B)
    ...
    sim_param(record).bwconstraint = B(i);
    sim_param(record).bwdatabase = 'BW99percent';
    sim_param(record).filename = strcat( data_directory, ['FSK16B' int2str(10*B(i)) '_AWGN.mat'] );
end
...
for i=1:length(B)
    ...
    sim_param(record).bwconstraint = B(i);
    sim_param(record).bwdatabase = 'BW99percent';
    sim_param(record).filename = strcat( data_directory, ['FSK32B' int2str(10*B(i)) '_AWGN.mat'] );
end
...
for i=1:length(B)
    ...
    sim_param(record).bwconstraint = B(i);
    sim_param(record).bwdatabase = 'BW99percent';
    sim_param(record).filename = strcat( data_directory, ['FSK64B' int2str(10*B(i)) '_AWGN.mat'] );
end
